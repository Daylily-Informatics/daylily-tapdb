...
class tapdb_core(Base):
    ...
    Attributes:
        uuid: Primary key, generated by database identity sequence
        euid: Enterprise Unique ID, generated by database trigger
        euid_prefix: EUID prefix used to create this row
        euid_seq: Numeric sequence value encoded into EUID body
